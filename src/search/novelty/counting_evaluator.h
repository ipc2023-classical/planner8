#ifndef NOVELTY_COUNTING_EVALUATOR_H
#define NOVELTY_COUNTING_EVALUATOR_H
...
class CountingEvaluator : public Heuristic {
    const int width;
...
public:
    explicit CountingEvaluator(const options::Options &opts);
};
}
